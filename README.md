...
· ✅ LoginRequiredMixin для защиты CBV
· ✅ Общедоступный просмотр списка товаров и деталей
· ✅ Ограниченный доступ к созданию/редактированию/удалению
· ✅ Динамические кнопки в шаблонах - скрыты для анонимных пользователей
...
/product/<int:pk>/update/ Редактирование товара Только авторизованные
/product/<int:pk>/delete/ Удаление товара Только авторизованные
